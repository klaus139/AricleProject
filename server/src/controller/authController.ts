...
const authCtrl = {
  ...
  refreshToken: async(req: Request, res: Response) => {
    try {
      ...
      const user:any = await User.findById(decoded.id).select("-password +rf_token")
  ...
  googleLogin: async(req: Request, res: Response) => {
    try {
      ...
      const user:any = await User.findOne({account: email})
  ...
  smsVerify: async(req: Request, res: Response) => {
    try {
      ...
      const user:any = await User.findOne({account: phone})
